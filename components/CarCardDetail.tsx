...
const CarCardDetail = ({isOpen, closeModal, car}: CarDetails) => {
  return (
    <>
      <Transition
          ...
          <Dialog as = "div" className="relative z-10" onClose = { closeModal }>
            ...
            >
              ...
              p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                <button
                  type="button"
                  className="absolute top-2 right-2 z-10 w-fit p-2 bg-primary-blue-100 rounded-2xl text-white"
                  onClick={ closeModal }
                >
                  <Image
                    src="/close.svg"
                ...
                <div className="flex-1 flex flex-col gap-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Image src={generateCarImageUrl(car, '19')} alt = "Car Model" fill priority className = "object-contain"/>
                    </div>
                    <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
